...
<div class="row">
      <div class="medium-12 large-12 columns">
        ...
        <div class="medium-2  columns"><a class="button hollow success" href="{{ route('export_clients') }}">EXPORT CLIENTS</a></div>
        ...
        <th width="200">Name</th><th width="200">Email</th><th width="200">Action</th>
          ...
          @foreach( $clients as $client )
              <tr>
  <td>{{ $client->name }} {{ $client->last_name }}</td><td>{{ $client->email }}</td>
                <td>
