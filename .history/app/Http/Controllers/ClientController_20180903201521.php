...
class ClientController extends Controller
{
    ...
    public function __construct( Title $titles, Client $client )
    {
        ...
        $this->client = $client; //Important for editing existing clients
    }
    ...
    public function index()
    {
        ...
        $client = DB::table('users')->get()->reverse(); /*You may use the table method on the DB facade to begin a query. The table method returns a fluent query builder instance for the given table, allowing you to chain more constraints onto the query and then finally get the results using the get method: */
