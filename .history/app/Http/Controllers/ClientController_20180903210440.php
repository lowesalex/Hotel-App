...
The incoming request instance will automatically be injected by the service container: */
        ...
        $data['modify'] = 0; // inside blde there is an if statement to check if modified  {{ $modify == 1 ? 'Modify Client' : 'New Client' }}
        return view('client/form', $data);//pass all the input fileds of the forms as array within the $data variables
    }
