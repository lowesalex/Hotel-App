...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        $client = DB::table('users')->get()->reverse(); /*You may use the table method on the DB facade to begin a query. The table method returns a fluent query builder instance for the given table,
